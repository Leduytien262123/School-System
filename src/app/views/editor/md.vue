<template>
  <n-grid cols="12" y-gap="20" x-gap="20" item-responsive responsive="screen">
    <n-grid-item span="12 m:12 l:12">
      ...
      >
        <n-form-item label="Chọn giao diện xem trước:" path="inputValue">
          <n-select
            class="w-[150px]"
            v-model:value="compData.previewTheme"
            :options="previewTheme"
          />
        </n-form-item>
        <n-form-item label="Chọn giao diện mã nguồn:" path="inputValue">
          <n-select
            class="w-[150px]"
            v-model:value="compData.codeTheme"
            :options="codeTheme"
          >
          </n-select>
        </n-form-item>
    ...
    <n-grid-item span="12 m:12 l:12">
      ...
      >
        <MdEditor
          class="h-full"
          :previewTheme="compData.codeTheme"
          v-model="compData.text"
        />
      </n-card>
    </n-grid-item>
  </n-grid>
...
const html = $global.helpers.readFile("/hello.text");
