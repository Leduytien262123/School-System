<template>
  <n-grid cols="12" y-gap="20" x-gap="20" item-responsive responsive="screen">
    <n-grid-item class="h-full" span="12 m:12 l:12">
      <n-card
        title="Danh sách ảo - Cuộn đến vị trí"
        style="height: 100%"
