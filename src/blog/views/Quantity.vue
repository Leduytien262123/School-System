  ...
  >
    <n-grid cols="12" item-responsive responsive="screen" :x-gap="20">
      <n-grid-item span="12 m:6 l:3" v-for="item in compData.items">
        <div class="mt-[30px]">
          <div
            class="circle wow animate__animated animate__slideInLeft"
          ...
          <h5
            class="wow animate__animated animate__slideInRight font-bold text-[17px] text-white relative mt-[15px] mb-[20px]"
            data-wow-duration="1.0s"
            data-wow-delay="0.5"
          >
            <n-number-animation
